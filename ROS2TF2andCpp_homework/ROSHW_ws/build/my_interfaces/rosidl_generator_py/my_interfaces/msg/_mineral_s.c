...
bool my_interfaces__msg__mineral__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._mineral.Mineral", full_classname_dest, 34) == 0);
  }
  my_interfaces__msg__Mineral * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Mineral */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._mineral");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Mineral");
