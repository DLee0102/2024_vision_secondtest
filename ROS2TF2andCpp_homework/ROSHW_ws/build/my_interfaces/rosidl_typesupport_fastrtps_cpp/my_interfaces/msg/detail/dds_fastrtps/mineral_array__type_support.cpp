...
#include "my_interfaces/msg/detail/mineral_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const my_interfaces::msg::Mineral &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: minerals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        my_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Mineral(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::MineralArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::MineralArray *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_MineralArray__handle;
}
