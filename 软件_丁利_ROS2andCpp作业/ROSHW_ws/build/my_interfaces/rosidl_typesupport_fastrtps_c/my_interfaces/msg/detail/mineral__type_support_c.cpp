...
#include "my_interfaces/msg/detail/mineral__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // species
#include "rosidl_runtime_c/string_functions.h"  // species
...
using _Mineral__ros_msg_type = my_interfaces__msg__Mineral;
...
static uint32_t _Mineral__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__Mineral(
...
static size_t _Mineral__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__Mineral(
